...
citations = Citations.load('citations.bib', package='q2_iqtree2')
plugin = Plugin(
    name='iqtree2',
    version=q2_iqtree2.__version__,
    website='https://github.com/mikerobeson/q2-iqtree',
    package='q2_iqtree2',
    description=('This QIIME 2 plugin supports generating phylogenetic '
                 'trees with IQ-TREE 2.'),
    short_description='Plugin for generating phylogenies wiht IQ-TREE 2.'
)


plugin.methods.register_function(
    function=q2_iqtree2.iqtree,
...
plugin.methods.register_function(
    function=q2_iqtree2.iqtree_ultrafast_bootstrap,
    inputs={'alignment': FeatureData[AlignedSequence]},
    parameters={
            'seed': Int,
            'n_cores': Int % Range(1, None) | Str % Choices(['auto']),
...
plugin.pipelines.register_function(
    function=q2_iqtree2.align_to_tree_mafft_iqtree,
    inputs={
