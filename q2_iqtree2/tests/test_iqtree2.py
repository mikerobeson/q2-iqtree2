...
from q2_iqtree2 import iqtree, iqtree_ultrafast_bootstrap
from q2_iqtree2._iqtree2 import (run_command, _build_iqtree_command,
...
class IqtreeTests(TestPluginBase):
    ...
    def test_iqtree_with_seed(self):
        ...
        #     iqtree -seed 1723 -m HKY -s aligned-dna-sequences-1.fasta
        #            -nt 1 -pre q2iqtree
        ...
        exp_tree = skbio.TreeNode.read(self.get_data_path('test1.tre'))
    ...
    def test_iqtree_ultrafast_bootstrap_singlebranch_methods(self):
        ...
        #  iqtree -s aligned-dna-sequences-1.fasta -alrt 1500 -lbp 1500
